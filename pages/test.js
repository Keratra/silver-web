...
// 						ml: { sm: `${drawerWidth}px` },
// 					}}
// 					className={`bg-white shadow-sm shadow-neutral-300`}
// 				>
// 					<Toolbar
// 						variant='dense'
...
// 						>
// 							<FiMenu size={22} className={`cursor-pointer text-black`} />
// 						</IconButton>
...
// 						<section onClick={logout} className=''>
// 							{/* {['admin', 'dealer'].includes(appState.userType) ? 'true' : 'false'} */}
// 							<NextLink href='/' passHref>
// 								<Link
// 									className={`text-black no-underline hover:text-rose-500 transition-colors`}
// 								>
// 									<FiLogOut
// 										size={22}
// 										// ['admin', 'dealer'].includes(appState.userType) && logout
// 										className={`rotate-180 inline-block align-text-bottom`}
// 									/>
// 								</Link>
// 							</NextLink>
// 						</section>
...
// 					className='h-full'
// 				>
// 					<div className='mt-6 mb-4 text-xl text-center'>
// 						<NextLink href={titlePath} passHref>
...
// 											<ListItemIcon className={`inline-block`}>
// 												{icon}
// 											</ListItemIcon>
// 											<ListItemText className={`inline-block`} primary={name} />
// 										</ListItemButton>
// 									</Link>
// 								</NextLink>
// 							</ListItem>
